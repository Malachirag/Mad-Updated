...
public class Firebase extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kgf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                videouri= Uri.parse("https://firebasestorage.googleapis.com/v0/b/e-learning-e32be.appspot.com/o/VID-20230513-WA0012.mp4?alt=media&token=dd1394e1-3264-4fb2-bfa8-0d974413bd0a");
        ...
        kirik.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                videouri= Uri.parse("https://firebasestorage.googleapis.com/v0/b/edu-tech-77e88.appspot.com/o/VID-20230513-WA0012.mp4?alt=media&token=cfc3c673-3e7d-4ac3-8970-ac8b9c3cd2b7");
                run_movie(videouri,"HTML");
            }
        });
